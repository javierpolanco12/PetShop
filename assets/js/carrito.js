class Carrito {
    ...
    leerDatosProducto(producto) {
        const infoProducto = {
            ...
            // Asegurarse de manejar la moneda correctamente
            precio: parseFloat(producto.querySelector('.precio').textContent.replace('S/.', '').replace('MXN$', '').trim()),
    ...
    calcularTotal() {
        ...
        // Actualización para soportar tanto soles como pesos mexicanos
